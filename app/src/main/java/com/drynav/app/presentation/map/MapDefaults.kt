 ...
 *
 * Custom character markers are not rendered through this system — Mapbox's location-indicator
...
fun MapView.applyDryNavLocationPuck() {
    ...
    location2.updateSettings2 {
        // COURSE is the direction the vehicle is actually moving, which is
        // what a driving-navigation arrow should represent. The ViewModel
        // feeds this same map-matched bearing into the puck during navigation.
        puckBearingEnabled = true
        puckBearingSource = PuckBearingSource.COURSE
    }
}

/** Toggles the default Mapbox puck. */
