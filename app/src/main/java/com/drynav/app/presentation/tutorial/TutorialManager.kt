...
private fun buildTutorialSteps(): List<TutorialStep> = listOf(
    ...
    TutorialStep(
        ...
        targetKey = "pin_tool",
        title = "Pin the flood",
        description = "Tap Pin Flood, then tap the map to place or adjust the exact flood location. The flood size slider appears while pinning."
    ),
    TutorialStep(
        route = Routes.REPORT,
        targetKey = "photo_picker",
        title = "Add a photo",
        description = "Take a live camera photo of the flooding. Gallery uploads are not allowed for flood reports."
    ),
    TutorialStep(
        route = Routes.REPORT,
        targetKey = "severity_toggle",
        title = "Passable or blocked",
        description = "Choose Passable or Not Passable for the flooded road."
    ),
    TutorialStep(
        route = Routes.REPORT,
    ...
    TutorialStep(
        ...
        targetKey = "profile_page",
        title = "Your profile",
        description = "View your profile and manage the features available here, including profile details, notifications, dark mode, your plan, logout, and account deletion."
    ),
)
